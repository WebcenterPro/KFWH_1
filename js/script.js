...
$(function(){
	...
	/* Показ модального окна на мобильном разрешении */
	
	$("#showPurchaseModal").on("click", function() {
		$("#purchaseModal").modal();
	});
	...
	$('.icon_short').tooltip({"title": "Избранное"});
	$('.icon_comp').tooltip({"title": "Сравнения"});
	$('.print_btn').tooltip({"title": "Печать"});
	$('.viewed_btn').tooltip({"title": "История просмотров"});
